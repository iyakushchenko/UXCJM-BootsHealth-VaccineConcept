...
import type { ViewportAnomaly } from "@/app/shell/playbackViewportAnomalies";
import type { RetreatAnomaly } from "@/app/shell/playbackRetreatAnomalies";
import {
...
} from "@/app/shell/playbackViewportMonitor";
...
export function usePlaybackViewportGuard({
  snapshot,
  currentBeat,
  scrollRootRef,
  onDiagnostic,
