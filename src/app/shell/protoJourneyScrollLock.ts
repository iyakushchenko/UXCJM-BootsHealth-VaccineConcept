...
export const PROTO_JOURNEY_SCROLL_LOCK_CLASS = "proto-scroll--journey-locked";
...
export function bindProtoJourneyScrollLock(scrollEl: HTMLElement): () => void {
  scrollEl.classList.add(PROTO_JOURNEY_SCROLL_LOCK_CLASS);
  ...
  return () => {
    scrollEl.classList.remove(PROTO_JOURNEY_SCROLL_LOCK_CLASS);
