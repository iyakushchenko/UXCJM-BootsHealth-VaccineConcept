...
const ALLOWLIST = {
  ...
  "src/app/shell/agent-testing/agentTestingOverlay.ts": 2800, // + sessionKind handoff/ask/escalate; SSoT in agentTestingSession.ts
  "src/app/nav/studioNavPanel.css": 1650, // + observe soft BUG chip lock state
