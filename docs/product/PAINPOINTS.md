...
| PP-14 | Chat bubble motion polish | Progressive / thinking→reply pull-up must be continuous ease (face of product) — agents need dump forensics, not DevTools-only. | COMPLETE | 2026-07-21 self-test 8/8 jumps=0; scroll re-anchor + thinking exit sync + HelpfulStrip defer; north star in MOTION/CHAT_PAGE_RAILS |
