...
| Component library / typical action kits | [Pending-commit spinner icon](#topic-pending-spinner-icon) | Reusable `src/uxds/interactions/` primitives beyond Accordion/Disclosure/FilterChip — optimistic-flip-then-delayed-commit affordances |
