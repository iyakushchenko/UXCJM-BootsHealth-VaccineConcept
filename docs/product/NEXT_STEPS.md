...
3e. [~] **PDP PAGE FINAL PASS** — **NEEDS-REPROVE** after PO polish (FAQ Make bodies 3/6 + download tertiary unify + accordion focus-none). Prior HARD-GREEN @ `828ab2b` / v0.0.27 demoted. Structure stamp retained; Quinn MCP + Uma §0a must re-prove then Arch restore. **Home still waits PO `+` + Final Pass HARD-GREEN.**
