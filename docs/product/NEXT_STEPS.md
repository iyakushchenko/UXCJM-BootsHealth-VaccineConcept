...
3e. [~] **PDP PAGE FINAL PASS** — structure stamp + `check:page-final-pass` green; **mcpFinalPass NEEDS-REPROVE** after Accordion Motion height (v0.0.37) — prior HARD-GREEN @ `57775a3` / v0.0.36. Quinn must re-prove MCP + accordion tween before restore. Uma §0a **PROVEN** @ `76e2433` (FAQ bodies). Audit: [FE_AUDIT_PDP_PAGE_FINAL_PASS_2026-07-19.md](../projects/boots-pharmacy/audits/FE_AUDIT_PDP_PAGE_FINAL_PASS_2026-07-19.md). **Home still waits PO `+` + HARD-GREEN.**
