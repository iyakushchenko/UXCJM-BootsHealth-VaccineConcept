...
6. [~] **Chat React migration** — thread/CTAs/thinking/composer ported behind `CHAT_REACT_MOUNT_ENABLED=false` (Make playback still live). Register [CHAT_MAKE_PARITY_REGISTER.md](../projects/boots-pharmacy/features/CHAT_MAKE_PARITY_REGISTER.md) · brief [CHAT_REACT.md](../projects/boots-pharmacy/features/CHAT_REACT.md) · **NOT hard-green / NOT PROVEN**. PDP HARD-GREEN unchanged. **Flip ON** only after Quinn P1–P10 React playback smoke green.
