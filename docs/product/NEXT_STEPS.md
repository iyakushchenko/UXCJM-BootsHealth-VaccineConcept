...
0a. [ ] **QA overlay trust / dual-role self-test (PP-13)** — load-bearing tool; self-test required after overlay ships. Pack: [`src/app/shell/agent-testing/SELF_TEST.md`](../../src/app/shell/agent-testing/SELF_TEST.md) · `__studioRunQaSelfTestSmoke()`. Marathon fixed observe→Alarm escalate (v0.0.79). Keep eyes until residuals rare.
